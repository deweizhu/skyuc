...
$_LANG['stand_backup_note'] ='備分除系統日誌以外所有表';
$_LANG['min_backup'] ='最小備份';
$_LANG['min_backup_note'] ='備分系統必需的重要資料表';
$_LANG['custom_backup'] ='自定義備份';
$_LANG['custom_backup_note'] ='根據自行選擇備份數據表';

$_LANG['option'] = '其他選項';
$_LANG['ext_insert'] = '使用擴展插入(Extended Insert)方式';
//$_LANG['sql_compatible'] = '建表語句格式';
$_LANG['default'] = '默認';
$_LANG['db_export_usehex'] = '十六進制方式';
$_LANG['db_export_usezip'] = '壓縮備份文件';
$_LANG['db_export_zip'] = '壓縮備份';
$_LANG['db_export_zip_1'] = '多分卷壓縮成一個文件';
$_LANG['db_export_zip_2'] = '每個分卷壓縮成單獨文件';
$_LANG['db_export_zip_3'] = '不壓縮';
$_LANG['db_export_multivol'] = 'SKYUC! 分卷備份 - 文件長度限制(kb)';
$_LANG['db_export_filename'] = '備份文件名';
...
$_LANG['unrecognize_version'] = '不能識別備份sql的SKYUC!版本';
...
$_LANG['version_error'] = 'SKYUC! 當前版本%s與備份數據版本%s不同，備份恢復失敗';
...
/* 數據備份 */
$_LANG['restore_title'] = '數據文件 %s 成功恢復，程序將自動繼續。';
$_LANG['backup_title'] = '數據文件 %s 成功創建，程序將自動繼續。';
$_LANG['no_zip_title'] = '文件 %s 不存在，或者它不是一個可識別的文件。';
