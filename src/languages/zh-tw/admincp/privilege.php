...
$_LANG['js_languages']['password_empty'] = '管理員密碼不能為空!';
...
$_LANG['edit_remove_cannot'] = '您不能刪除這個管理員!';
...
/* 登錄表單 */
$_LANG['label_username'] = '管理名稱：';
$_LANG['label_password'] = '管理密碼：';
$_LANG['label_captcha'] = '圖像驗證';
$_LANG['input_captcha'] = '請輸入圖像中的六位數字或字母。';
$_LANG['click_for_another'] = '看不清？點擊更換另一個驗證碼。';
$_LANG['refurbish_captcha'] = '刷新圖像';
