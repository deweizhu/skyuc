...
$_LANG['edit_remove_cannot'] = '您不能删除这个管理员!';
...
/* 登录表单 */
$_LANG['label_username'] = '管理名称：';
$_LANG['label_password'] = '管理密码：';
$_LANG['label_captcha'] = '图像验证';
$_LANG['input_captcha'] = '请输入图像中的六位数字或字母。';
$_LANG['click_for_another'] = '看不清？点击更换另一个验证码。';
$_LANG['refurbish_captcha'] = '刷新图像';
