...
$_LANG['need_not_setup'] = '当您采用SKYUC!会员系统时，无须进行设置。';
$_LANG['different_domain'] = '您设置的整合对象和 SKYUC! 不在同一域下。<br />您将只能共享该系统的会员数据，但无法实现同时登录。';
...
/* 表单相关语言项 */
$_LANG['db_notice'] = '点击“<font color="#000000">下一步</font>”将引导你到将网站用户数据同步到整合论坛。如果不需同步数据请点击“<font color="#000000">直接保存配置信息</font>”';
...
/* 检查同名用户 */
$_LANG['conflict_username_check'] = '检查网站用户是否和整合论坛用户有重名';
$_LANG['check_notice'] = '本页将检测网站已有用户和论坛用户是否有重名，点击“开始检查前”，请为网站重名用户选择一个默认处理方法';
$_LANG['default_method'] = '如果检测出网站有重名用户，请为这些用户选择一个默认处理方法';
$_LANG['site_user_total'] = '网站共有 %s 个用户待检查';
...
/* 同名用户处理 */
$_LANG['conflict_username_modify'] = '网站重名用户列表';
$_LANG['modify_notice'] = '以下列出了所有网站与论坛的重名用户及处理方法。如果您已确认所有操作，请点击“开始整合”；您对重名用户的操作的更改需要点击按钮“保存本页更改”才能生效。';
$_LANG['page_default_method'] = '本页面中重名用户默认处理方法';
$_LANG['lable_rename'] = '网站重名用户加后缀';
$_LANG['lable_delete'] = '删除网站的重名用户及相关数据';
$_LANG['lable_ignore'] = '保留网站重名用户，论坛同名用户视为同一用户';
$_LANG['short_rename'] = '网站用户改名为';
$_LANG['short_delete'] = '删除网站用户';
$_LANG['short_ignore'] = '保留网站用户';
$_LANG['user_name'] = '网站用户名';
$_LANG['email'] = 'email';
$_LANG['reg_date'] = '注册日期';
$_LANG['all_user'] = '所有网站重名用户';
$_LANG['error_user'] = '需要重新选择操作的网站用户';
$_LANG['rename_user'] = '需要改名的网站用户';
$_LANG['delete_user'] = '需要删除的网站用户';
$_LANG['ignore_user'] = '需要保留的网站用户';
...
/* 用户同步 */
$_LANG['user_sync'] = '同步网站数据到论坛，并完成整合';
$_LANG['button_pre'] = '上一步';
$_LANG['task_name'] = '任务名';
$_LANG['task_status'] = '任务状态';
$_LANG['task_del'] = '%s 个网站用户数待删除';
$_LANG['task_rename'] = '%s 个网站用户需要改名';
$_LANG['task_sync'] = '%s 个网站用户需要同步到论坛';
...
$_LANG['ucenter_lab_credit_0'] = '消费积分名称:';
...
$_LANG['ucenter_notice_key'] = '通信密钥用于在 UCenter 和 SKYUC! 之间传输信息的加密，可包含任何字母及数字，请在 UCenter 与 SKYUC! 设置完全相同的通讯密钥，以确保两套系统能够正常通信';
...
$_LANG['uc_notice_ip'] = '连接的过程中出了点问题，请您填写服务器 IP 地址，如果您的 UC 与 SKYUC! 装在同一服务器上，我们建议您尝试填写 127.0.0.1';
...
$_LANG['help_notice'] = '使用方法：
         ...
         3:如果不需要整合任何用户系统，请选择安装 SKYUC! 插件，即可卸载所有的整合插件。';
?>
