...
$_LANG['stand_backup_note'] ='备分除系统日志以外所有表';
$_LANG['min_backup'] ='最小备份';
$_LANG['min_backup_note'] ='备分系统必需的重要资料表';
$_LANG['custom_backup'] ='自定义备份';
$_LANG['custom_backup_note'] ='根据自行选择备份数据表';

$_LANG['option'] = '其他选项';
$_LANG['ext_insert'] = '使用扩展插入(Extended Insert)方式';
//$_LANG['sql_compatible'] = '建表语句格式';
$_LANG['default'] = '默认';
$_LANG['db_export_usehex'] = '十六进制方式';
$_LANG['db_export_usezip'] = '压缩备份文件';
$_LANG['db_export_zip'] = '压缩备份';
$_LANG['db_export_zip_1'] = '多分卷压缩成一个文件';
$_LANG['db_export_zip_2'] = '每个分卷压缩成单独文件';
$_LANG['db_export_zip_3'] = '不压缩';
$_LANG['db_export_multivol'] = 'SKYUC! 分卷备份 - 文件长度限制(kb)';
$_LANG['db_export_filename'] = '备份文件名';
...
$_LANG['unrecognize_version'] = '不能识别备份sql的SKYUC!版本';
...
$_LANG['version_error'] = 'SKYUC! 当前版本%s与备份数据版本%s不同，备份恢复失败';
...
/* 数据备份 */
$_LANG['restore_title'] = '数据文件 %s 成功恢复，程序将自动继续。';
$_LANG['backup_title'] = '数据文件 %s 成功创建，程序将自动继续。';
$_LANG['no_zip_title'] = '文件 %s 不存在，或者它不是一个可识别的文件。';
