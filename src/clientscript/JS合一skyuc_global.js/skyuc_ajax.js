 ...
 * @author          SKYUC R&D Team ( http://www.skyuc.com/ )
 * @date            2008-01-16 ZDW <zdw163@hotmail.com>
**/
  ...
  run : function (url, params, callback, transferMode, responseType, asyn, quiet)
  {
    ...
    catch (ex)
    {
      if (typeof(self.onComplete) === "function")
      {
		...
		alert(this.filename + "/run() error:" + ex);
  ...
  */
  parseParams : function (params)
  {
    ...
    else if (typeof(params) === "object")
    {
      try
      {
        legalParams = "JSON=" + $.toJSON(params); //调用jquery插件JSON
      }
      catch (ex)
      {
  ...
  parseResult : function (responseType, xhr)
  {
    ...
    switch (responseType)
    {
      case "JSON" :
        ...
        try
        {
          //result = $.evalJSON(result);  //调用jquery插件JSON
		  result =  eval("(" + result + ")");
        }
        catch (ex)
        {
