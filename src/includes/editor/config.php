...
define('CSRF_SKIP_PROTECTION', true);//跳过CSRF 保护，否则上传文件失败
define('LOCATION_BYPASS', 1);
define('NOSHUTDOWNFUNC', true);
define('CWD', preg_replace("/includes(.*)/i", '', __FILE__ ));
...
function CheckAuthentication()
{
	...
	return $skyuc->session->vars['adminid'] ? true : false;
}

// LicenseKey : Paste your license key here. If left blank, CKFinder will be
// fully functional, in demo mode.
$config['LicenseName'] = 'SKYUC';
$config['LicenseKey'] = '550BD6A61F1EN9C63B8DE7AA18ADED3C';
