...
<tr>
  ...
  <td align="center"><!-- {if $val.id} --><a href="navigator.php?{$session.sessionurl}act=edit&id={$val.id}" title="{$lang.edit}"><img src="images/icon_edit.gif" width="16" height="16" border="0" /></a>
