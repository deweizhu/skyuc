...
<div class="form-div">
  ...
  <select class="textCtrl"  name="flag">
...
<input type="submit" class="button primary submitButton" value="{$lang.submit_modify}"   />
<input type="button" class="button"  value="{$lang.button_confirm_next}" onclick="location.href='integrate.php?act=sync'"  />
</div>
</form>
